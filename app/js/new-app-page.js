...
function startEveningSwiper2() {
  const eveningSwiper2 = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.eveningSwiper2', {
...
function initOrDestroySwiperFeaturesSwiper() {
  ...
  if (screenWidth <= 799 && !featuresSwiper) {
    featuresSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.featuresSwiper', {
      modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination],
      loop: true,
      slidesPerView: 1.2,
      grabCursor: true,
