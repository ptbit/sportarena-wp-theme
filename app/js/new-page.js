...
function initOrDestroyInfoSwiper() {
  ...
  if (screenWidth <= 620 && !infoSwiper) {
    infoSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper', {
...
function initCasinosSwiper() {
  const casinoSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.casinosSwiper', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination],
    loop: true,
    slidesPerView: 1.2,
    spaceBetween: 15,
